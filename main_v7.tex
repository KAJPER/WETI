...
\begin{figure}[H]
    ...
    wartości C4 (\SI{1}{\nano\farad}$\to$\SI{47}{\pico\farad}),
    C5 (\SI{100}{\pico\farad}$\to$\SI{33}{\pico\farad}),
    R3 (\SI{100}{\kilo\ohm}$\to$\SI{470}{\kilo\ohm}),
    C2 (\SI{10}{\micro\farad}$\to$\SI{1}{\micro\farad})
    zostały zoptymalizowane w~niniejszym dokumencie
    (patrz sekcja~\ref{sec:tor_rx}). Tabela~\ref{tab:zmienione_wartosci}
    zestawia wszystkie zmienione wartości. Schemat zostanie zaktualizowany
...
\begin{table}[H]
    \centering
    \caption{Zestawienie wartości elementów zmienionych względem schematu}
    \label{tab:zmienione_wartosci}
    \begin{tabularx}{\textwidth}{l r r X}
        \toprule
        \textbf{Element} & \textbf{Schemat} & \textbf{Finalna} & \textbf{Uzasadnienie} \\
        \midrule
        C4 & \SI{1}{\nano\farad} & \SI{47}{\pico\farad} & $f_{LP}$ za niska --- tłumienie zamiast wzmocnienia @ $f_0$ \\
        C5 & \SI{100}{\pico\farad} & \SI{33}{\pico\farad} & Poprawa wzmocnienia 2.~stopnia @ $f_0$ \\
        R3 & \SI{100}{\kilo\ohm} & \SI{470}{\kilo\ohm} & Zwiększenie wzmocnienia AC 2.~stopnia \\
        C2 & \SI{10}{\micro\farad} & \SI{1}{\micro\farad} & Eliminacja efektu piezoelektrycznego ceramiki \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l l r r r X}
        ...
        Goldpiny 1x02 & --- & 4 & 0,30 & 1,20 & TME \\
        Goldpiny 1x03 & UPDI & 1 & 0,35 & 0,35 & TME \\
        Goldpiny 1x01 & TP & 2 & 0,15 & 0,30 & TME \\
        Nadajnik US 40\,kHz & TX & 1 & 3,50 & 3,50 & TME \\
        Odbiornik US 40\,kHz & RX & 1 & 3,50 & 3,50 & TME \\
        NTC 10\,k$\Omega$ & NTC & 1 & 0,90 & 0,90 & TME \\
        \midrule
        \multicolumn{4}{r}{\textbf{RAZEM:}} & \textbf{40,16} & PLN \\
        \bottomrule
    \end{tabularx}
\end{table}
