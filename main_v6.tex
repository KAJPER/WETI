...
\begin{figure}[H]
    ...
    \textit{Uwaga:} Schemat przedstawia wstępną wersję projektu ---
    wartości C4, C5, R3, C2 zostały zoptymalizowane w~niniejszym dokumencie
    (patrz sekcja~\ref{sec:tor_rx}). Schemat zostanie zaktualizowany
    przed oddaniem prototypu w~Etapie~2.}
    \label{fig:schemat}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l r X}
        ...
        $I_{DD}$ active & ${\sim}\SI{3,1}{\milli\ampere}$ & @ \SI{10}{\mega\hertz}, \SI{3,3}{\volt} (DS Tab.~36-4: typ.\ 3{,}1\,mA @ 3V/10MHz) \\
...
\begin{table}[H]
    ...
    \begin{tabular}{llll}
        ...
        PA6 & --- & --- & (nieużywany, rezerwowy GPIO; DAC0 wewnętrznie dla AC0) \\
...
\begin{enumerate}[nosep]
    ...
    \item Komparator AC0 porównuje sygnał z~progiem ustawionym przez
          ...
          Histereza typ.\ $\pm\SI{30}{\milli\volt}$ (HYSMODE = 0x2,
...
\begin{table}[H]
    ...
    \begin{tabular}{llrrrl}
        ...
        Cewka \SI{10}{\micro\henry} & L1 & 1 & 0,15 & 0,15 & regulamin (filtr EMI zasilania) \\
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrr}
        ...
        \midrule
        ATtiny1616 @ 10\,MHz, 3{,}3\,V
            & ${\sim}\SI{3,1}{\milli\ampere}$
            & \SI{0,7}{\micro\ampere}
            & \SI{5}{\milli\second}
            & DS Tab.~36-4 (typ.\ 3{,}1\,mA @ 3V/10MHz) \\
        ...
        Nadajnik US (burst)
            ...
            & \SI{0}{\micro\ampere}
            & \SI{0,2}{\milli\second}
            & estymacja; \textbf{zasilany z~5V} (nie przez LDO) \\
        LED (puls)
            & \SI{3,3}{\milli\ampere}
            & \SI{0}{\micro\ampere}
            & \SI{1}{\milli\second}
...
\begin{equation}
    I_{avg,1} = 3{,}1 + 0{,}1 + 0{,}002 + 3{,}3 \cdot 0{,}2 \approx \SI{3,9}{\milli\ampere}
\end{equation}
...
\begin{equation}
    ...
    = \frac{3{,}9 \cdot 3{,}3}{0{,}66} + 0{,}8 \cdot 5 = 19{,}5 + 4{,}0 = \SI{23,5}{\milli\watt}, \quad
    P_{pkt,1} = 100/23{,}5 \approx \textbf{4,3~pkt}
\end{equation}
...
\begin{equation}
    ...
    = \frac{5 \cdot 3100 + 95 \cdot 0{,}7}{100} \approx \SI{156}{\micro\ampere}
    \label{eq:imcu_avg}
\end{equation}

Średni prąd całkowity (@ \SI{3,3}{\volt}, bez nadajnika):
\begin{equation}
    I_{avg,2} = 156 + 100 + 1{,}6 + 3300 \cdot \frac{1}{100}
    \approx \SI{291}{\micro\ampere}
\end{equation}
...
\begin{equation}
    ...
    = \frac{0{,}291 \cdot 3{,}3}{0{,}66} + 0{,}040 \cdot 5
    \approx 1{,}45 + 0{,}20 = \SI{1,7}{\milli\watt}, \quad
...
\begin{itemize}[nosep]
    ...
    \item Taktowanie MCU na \SI{5}{\mega\hertz} w~fazie obliczeń
          (prescaler $\div 4$, $I_{active} \approx \SI{1,8}{\milli\ampere}$, DS Tab.~36-4)
...
\textit{Uwaga:} Wyłączanie MCP6002 przez P-MOSFET (np.\ BSS84, ${\sim}\SI{0,50}{PLN}$
--- nieujęty w~BOM powyżej, do uwzględnienia w~Etapie~2) wymaga wydłużenia
